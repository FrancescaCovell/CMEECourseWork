...
"RasterLandscapePID0006_0.3.txt" "RasterLandscapePID0091_0.8.txt" "RasterLandscapePID0095_0.6.txt" "RasterLandscapePID0117_0.4.txt" "RasterLandscapePID0131_0.7.txt" "RasterLandscapePID1005_0.5.txt" 
"RandomLandscape1_0.1.txt" "RandomLandscape1_0.2.txt" "RandomLandscape1_0.3.txt" "RandomLandscape1_0.4.txt" "RandomLandscape1_0.5.txt" "RandomLandscape1_0.6.txt" "RandomLandscape1_0.7.txt" "RandomLandscape1_0.8.txt" "RandomLandscape1_0.9.txt")
...
do
    ...
    do
        ...
        do
            ./a.out $i $j $DispDist $InteractDist $IntraComp 1 $k &
            process_id=$!
        done
    done
done
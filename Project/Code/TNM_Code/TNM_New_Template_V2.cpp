...
const int numGenPost = 2000;                // Number of generations to run the model after fragmentation. Each generation is broken into time steps.
...
double calculateInteractions(double (&J)[numSpec][numSpec], int (&cellPopSpec)[numCells][numSpec], int (&cellPop)[numCells], double (&distArray)[numCells][numCells],
    ...
    validCells = findValidCells(distArray, 1.5, cell);

...
int main(int argc, char *argv[]) {
    ...
    int numGen = 0;
    if(numGen < numGenPre) {fragmentation == 0;} 
    else if (numGen > numGenPre && numGen < numGenPost) {fragmentation== 1;}
    ...
    // Then add a folder within the fragmentation folder for this specific landscape structure, which will be named after the landscape
